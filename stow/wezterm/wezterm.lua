...
local function get_process(tab)
	...
	local content = process_icons[process_name] and process_icons[process_name]
		or { { Foreground = { Color = colors.sky } }, { Text = string.format("[%s]", process_name) } }

	return wezterm.format(content)
end
...
return {
	...
	front_end = "WebGpu",
	color_scheme = is_dark and "Catppuccin Mocha" or "Catppuccin Latte",
	colors = {
